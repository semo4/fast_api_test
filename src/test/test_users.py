...
headers_ = {
    'Authorization':
    'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJvc0Bob3RtYWlsLmNvbSIsImV4cCI6MTYyNzU2Mzk4OX0.zr9fWoA1C35HECqPBy1kJUeyjeLkh_WJNYIIW_0Y57Q'
}
...
def test_delete_user(client, mocker: MockFixture):
    ...
    mock_users.return_value.where.return_value.execute.return_value.first.return_value = {
        "id": "f9d05432-9e45-4f5f-95c3-821f202c28df",
        "first_name": "osama10",
        "last_name": "osama10",
        "email": "os@hotmail.com",
        ...
        "updated_at": "2021-07-21T18:36:39.386112",
        "address": {
            "id": "add8fa65-08c1-4580-8700-d8f4ab35bdaf",
            "name": "Amman",
            "zip_code": "12345",
            "building_number": 5,
            "street_name": "grtgrthggbg",
...
def test_delete_user_wrong_id(client, mocker: MockFixture):
    mock_users = mocker.patch('controllers.users_controllers.users.select')
    mock_users.return_value.where.return_value.execute.return_value.first.return_value = {}
    response = client.delete('/users/f9d05432-9e45-4f5f-95c3-821f202c2847',
                             headers=headers_)
    assert response.status_code == 404
